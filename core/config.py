...
net_arg.add_argument(
    "--r_list", type=list, default=[0.125, 0.5, 0.5], help=""
    "list of k in graph U-Net.")
net_arg.add_argument(
...
train_arg.add_argument(
    "--log_base", type=str, default="./log_UMatch/", help="" 
...
test_arg.add_argument(
    "--model_path", type=str, default="/Pretrained_models/Outdoor-SIFT/", help=""
